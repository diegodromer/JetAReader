            ...
            Column(
                ...
                if (bookInfo.loading == true) {
                    ...
                    Surface(
                        ...
                        ShowBookUpdate(
                            bookInfo = viewModel.data.value, bookItemId = bookItemId
                        )
...
@Composable
fun ShowSimpleForm(
    book: MBook, navController: NavHostController
) {
...
@Composable
fun ShowAlertDialog(
    message: String, openDialog: MutableState<Boolean>, onYesPressed: () -> Unit
) {
...
@Composable
fun CardListItem(
    book: MBook, onPressDetails: () -> Unit
) {
    Card(
        modifier = Modifier
            .padding(
